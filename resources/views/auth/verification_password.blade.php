...
@section('body')
    <div class="container-fluid main-container p-0">
        <div class="row g-0 h-100 justify-content-center">
            <!-- الصورة تظهر بس على الشاشات الكبيرة -->
            ...
            <div class="col-12 col-md-8 col-lg-6 form-side">
                <div class="form-container">
                    ...
                    <form method="post" action="{{ route('virfction_password') }}">
                        @csrf
                        <input type="hidden" value="{{ $user->email }}" name="email">

                        <div class="input-group">
                            <input type="text" name="code" class="form-control" maxlength="6" placeholder="------"
                                required>
                            <i class="bi bi-key"></i>
                        </div>

                        <button type="submit" class="btn-submit shadow-sm mt-4">
