...
@section('title', $service_provider->name)
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ $service_provider->name }}</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="profile-card">
                    <div class="profile-card-top-section">
                        <div class="profile-img-container">
                            <img src="{{ URL::asset('assets/image/Profile/' . $service_provider->image) }}"
                    ...
                    <div class="profile-card-body">
                        <div class="user-info-header">
                            ...
                            @php
                                $averageRating = $service_provider->ratings->avg('rating');
                                $maxStars = 5;
                        ...
                        <div class="info-section">
                            @if (empty($service_provider->profile) || !$service_provider->profile->authenticated)
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <span>{{ $service_provider->name }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <span>{{ $service_provider->category->name ?? trans('dashboard.null') }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <strong>{{ trans('dashboard.phone_number') }}</strong>
                                    <span>{{ $service_provider->profile->phone_number ?? trans('dashboard.null') }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <strong>{{ trans('dashboard.University_name') }}</strong>
                                    <span>{{ $service_provider->profile->university_name ?? trans('dashboard.null') }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <strong>{{ trans('dashboard.Specialization') }}</strong>
                                    <span>{{ $service_provider->profile->specialization ?? trans('dashboard.null') }}</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="info-section">
                            ...
                            <p class="text-muted profile-description" style="direction: rtl; text-align: right;">
                                {{ $service_provider->profile->profile ?? trans('dashboard.no_profile_description') }}
                            </p>
                        </div>

                        <div class="info-section">
                            <h5 class="info-section-title">{{ trans('dashboard.skill') }}</h5>
                            @if ($service_provider->skills->isNotEmpty())
                                <div class="d-flex flex-wrap gap-2 mt-2">
                                    @foreach ($service_provider->skills as $skill)
                        ...
                        <div class="info-section">
                            ...
                            @if ($service_provider->myWorks->isNotEmpty())
                                <div class="my-works-grid">
                                    @foreach ($service_provider->myWorks as $work)
