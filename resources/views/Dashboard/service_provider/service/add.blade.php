        ...
        <div class="modal-content shadow-lg border-0" style="border-radius: 20px;">
            ...
            <form method="POST" action="{{route('service.store')}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" name="description" class="form-control form-control-lg rounded-pill border-0 shadow-sm" placeholder="{{trans('dashboard.description')}}" required>
                    </div>
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="number" name="price" class="form-control form-control-lg rounded-pill border-0 shadow-sm" placeholder="{{trans('dashboard.price')}}" required>
                    </div>
