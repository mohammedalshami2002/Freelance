<div class="modal fade text-left" id="editBackdrop{{$experience->id}}" tabindex="-1" aria-labelledby="editModalLabel" data-bs-backdrop="true" style="display: none;" aria-hidden="true">
            ...
            <form method="POST" action="{{route('experience.update', $experience->id)}}">
                ...
                <div class="modal-body">
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" name="name" value="{{ $experience->name }}" class="form-control form-control-lg rounded-pill border-0 shadow-sm" placeholder="{{trans('dashboard.name')}}" required>
                    </div>
                </div>
