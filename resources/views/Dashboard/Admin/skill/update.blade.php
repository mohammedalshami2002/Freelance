<div class="modal fade text-left" id="editBackdrop{{$skill->id}}" tabindex="-1" aria-labelledby="editModalLabel" data-bs-backdrop="true" style="display: none;" aria-hidden="true">
            ...
            <form method="POST" action="{{route('skill.update', $skill->id)}}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" name="name" value="{{ $skill->name }}" class="form-control form-control-lg rounded-pill border-0 shadow-sm" placeholder="{{trans('dashboard.name')}}" required>
                    </div>
