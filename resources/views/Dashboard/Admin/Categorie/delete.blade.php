<div class="modal fade text-left" id="deleteBackdrop{{$categorie->id}}" tabindex="-1" aria-labelledby="myModalLabel4" data-bs-backdrop="true" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content shadow-lg border-0" style="border-radius: 20px;">
            ...
            <form method="POST" action="{{route('categories.destroy',  $categorie->id)}}" enctype="multipart/form-data">
                @csrf
                @method('DELETE')
