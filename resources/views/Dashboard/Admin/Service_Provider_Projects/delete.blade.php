<div class="modal fade text-left" id="deleteBackdrop{{$servicer->id}}" tabindex="-1" aria-labelledby="myModalLabel4" data-bs-backdrop="true" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content shadow-lg border-0" style="border-radius: 20px;">
            ...
            <form method="POST" action="{{route('Service_Provider_Projects.delete',  $servicer->id)}}">
                @csrf
