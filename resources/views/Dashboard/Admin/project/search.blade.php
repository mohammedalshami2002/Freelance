        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.projects.index') }}">{{ trans('dashboard.projects') }}</a>
                    </li>
            ...
            <div class="card project-card">
                ...
                <div class="project-body">
                    ...
                    <div class="project-info-grid">
                        <div class="info-item"><i class="bi bi-person"></i> {{ $project->user->name }}</div>
                        <div class="info-item"><i class="bi bi-clock"></i> {{ $project->created_at->diffForHumans() }}</div>
                        <div class="info-item"><i class="bi bi-tag"></i>
                            <strong>{{ trans('dashboard.categorie') }}:</strong> {{ $project->categorie->name }}
                        </div>
                        <div class="info-item"><i class="bi bi-graph-up"></i>
                            <strong>{{ trans('dashboard.offer') }}:</strong> {{ $project->offer->count() }}
                        </div>
                        <div class="info-item"><i class="bi bi-currency-dollar"></i>
                            <strong>{{ trans('dashboard.price') }}:</strong> {{ $project->prise }}
                        </div>
                    </div>
