    ...
    <div class="sidebar-wrapper active ps ps--active-y">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Route::is('Client.dashboard') ? 'active' : '' }}">
                    <a href="{{ route('Client.dashboard') }}" class="sidebar-link">
                        <i class="bi bi-speedometer2"></i> <span>{{ trans('dashboard.dashboard') }}</span>
                    </a>
                </li>
                <li class="sidebar-item {{ Route::is('Prosodic.index') ? 'active' : '' }}">
                    <a href="{{ route('Prosodic.index') }}" class="sidebar-link">
                        <i class="bi bi-card-checklist"></i> <span>{{ trans('dashboard.projects') }}</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item {{ Route::is('Prosodic.create') ? 'active' : '' }}">
                    <a href="{{ route('Prosodic.create') }}" class="sidebar-link">
                        <i class="bi bi-file-plus-fill"></i> <span>{{ trans('dashboard.add_project') }}</span>
                    </a>
                </li>
